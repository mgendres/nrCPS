...
int main()
{
  ...
  if (1) {
    ...
    //---- Compare with the known sequence of numbers
    xsn[0]=13257445.0f;
    xsn[1]=15738482.0f;
    xsn[2]=5448599.0f;
    xsn[3]=9610459.0f;
    ...
    if (test==1) {
      ...
      printf("\n");
      printf("Test passed: ranlxs gives correct results\n");
      printf("\n");
    }
    ...
    if (test==2)
    {
      ...
      printf("\n");
      printf("Test passed: I/O routines for ranlxs work properly\n");
      printf("\n");
    }
  ...
  if (1) {
    ...
    if (test==1) {
      ...
      printf("\n");
      printf("Test passed: ranlxd gives correct results\n");
      printf("\n");
    }
    ...
    if (test==2)
    {
      ...
      printf("\n");
      printf("Test passed: I/O routines for ranlxd work properly\n");
      printf("\n");
    }
