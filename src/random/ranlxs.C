...
void Ranlxs::Init(long seed)
{
  ...
  const char* fname = "Ranlxs::Init(long)";
  int i,k,l;
...
{
  const char* fname = "Ranlxs::LuxLevel(int)";
...
{
  const char* fname = "Ranlxs::GetState(long*)";
  int k;  
...
{
  const char* fname = "Ranlxs::SetState(long*)";
  int k;
...
RandomType Ranlxs::TypeQ() {
  const char* fname = "RandomType Ranlxs::TypeQ()";
  switch ( lux_level ) {
    case 0 : 
      return RANDOM_TYPE_RANLXS0; break;
    case 1 : 
      return RANDOM_TYPE_RANLXS1; break;
    case 2 : 
      return RANDOM_TYPE_RANLXS2; break;
    default : 
